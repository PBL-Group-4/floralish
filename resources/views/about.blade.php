...
<body class="bg-gradient-to-br from-[#d1f0f5] to-[#a1d9db] min-h-screen flex flex-col">
        ...
        <div class="container mx-auto px-4 navbar-container flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center">
                ...
                <div class="dropdown {{ Auth::check() ? '' : 'hidden' }}" id="loggedInDropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="/about" class="dropdown-item">My Profile</a>
    ...
    <div class="flex-grow flex items-center justify-center p-6">
        <div class="flex flex-col md:flex-row bg-white rounded-tr-[50px] rounded-br-[50px] overflow-hidden shadow-lg max-w-6xl w-full">
            <!-- Gambar -->
            <div class="md:w-1/2 w-full flex justify-center items-center p-4">
                <img 
                    ...
                    class="rounded-xl border-4 border-[#7eaeb5] shadow-lg object-cover w-full max-w-sm h-auto"
                />
            </div>
    ...
    <footer class="bg-white mt-20">
        ...
        <div class="w-full bg-[#d1f0f5] py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="/about" class="text-gray-600 hover:text-[#7eaeb5] transition">About Us</a></li>
