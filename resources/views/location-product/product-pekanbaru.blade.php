...
@section('title', 'Offline Store Pekanbaru - Floralish')
...
<div class="relative bg-primary py-20">
    ...
    <div class="relative container mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">Offline Store Pekanbaru</h1>
        <p class="text-xl text-white/90">Temukan rangkaian bunga terbaik di toko kami di Pekanbaru</p>
    </div>
</div>
...
<div class="bg-white py-6 shadow-sm">
    <div class="container mx-auto px-4">
        <form action="{{ route('lokasi.show', ['location' => 'pekanbaru']) }}" method="GET" class="flex flex-wrap gap-4 justify-between items-center">
...
<div class="container mx-auto px-4 py-12">
    ...
    <div class="aspect-w-16 aspect-h-9">
        <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126932.123456789!2d101.4!3d0.5!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d5a9d2f2f2f2f2%3A0x31d5a9d2f2f2f2f2!2sPekanbaru%2C%20Indonesia!5e0!3m2!1sen!2sid!4v1234567890"
