...
@section('title', 'Offline Store Jakarta - Floralish')
...
<div class="relative bg-primary py-20">
    ...
    <div class="relative container mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">Offline Store Jakarta</h1>
        <p class="text-xl text-white/90">Temukan rangkaian bunga terbaik di toko kami di Jakarta</p>
    </div>
</div>
...
<div class="bg-white py-6 shadow-sm">
    <div class="container mx-auto px-4">
        <form action="{{ route('lokasi.show', ['location' => 'jakarta']) }}" method="GET" class="flex flex-wrap gap-4 justify-between items-center">
