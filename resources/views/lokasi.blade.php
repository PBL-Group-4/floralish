...
<section class="max-w-6xl mx-auto mt-6 px-4 sm:px-6 md:px-10 lg:px-16 relative">
  <div class="rounded-3xl overflow-hidden relative flex justify-center">
    ...
    <img 
      alt="Person holding white roses"
      class="rounded-3xl w-full max-w-4xl object-cover"
      src="{{ asset('image/lokasi_asset/Frame 2.png') }}" />

    <div class="absolute inset-x-4 sm:right-6 sm:left-auto top-1/2 transform -translate-y-1/2 bg-white rounded-2xl p-4 sm:p-6 w-auto sm:max-w-md shadow-lg">
      <h2 class="font-bold text-base sm:text-xl leading-tight mb-2 text-center">
        Toko Bunga & Florist Online Terlengkap, Kirim Se-Indonesia
      </h2>
      <p class="text-xs sm:text-sm font-semibold text-center mb-4">
        Toko bunga & florist online yang menghadirkan rangkaian bunga berkualitas tinggi...
      </p>
      <button 
        onclick="openLocationModal()" 
        class="btn-pilih bg-[#7eaeb5] text-white rounded-full px-5 py-2 mx-auto block shadow-md hover:bg-[#6a9ba3] transition-colors">
