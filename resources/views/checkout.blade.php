...
<div class="container mx-auto px-4 py-8 bg-gray-50 min-h-screen">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8">
            ...
            <!-- Product Detail -->
            <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 mb-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-4 border-b pb-3">Detail Pesanan</h2>
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            ...
                            <input type="number" name="qty" id="qty" value="1" min="1" max="99" required
                                class="w-24 rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 py-2 px-3 text-base transition-colors duration-200">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                <h2 class="text-xl font-semibold text-gray-800 mb-4 border-b pb-3">Informasi Pembayaran</h2>
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="tel" name="phone" id="phone" required pattern="^[0-9]+$"
                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 py-3 px-4 text-base transition-colors duration-200"
                        oninput="this.value = this.value.replace(/[^0-9]/g, '')"> <!-- Hanya Menerima Value Nomor -->
                    @error('phone')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <!-- Greeting Card -->
                <div class="mb-6">
                    <label for="admin_message" class="block text-sm font-medium text-gray-700 mb-2">Kartu Ucapan Untuk Penerima (Opsional)</label>
                    <textarea name="admin_message" id="admin_message" rows="3"
                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 py-3 px-4 text-base transition-colors duration-200" placeholder="Tulis pesanmu di sini... Ucapan hangat, doa terbaik, atau sekadar salam."></textarea>
                </div>

                <!-- Payment Information -->
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 shadow-md mt-6">
